...
import wbImg from "../img/weibo.png";
import wxImg from "../img/wx.png";
import Img1 from "../img/logo3.png";
import Img2 from "../img/sinin.png";
  ...
  function handelRegister() {
    ...
    if (password1 !== password2 || password2 === "") {
      ...
      if (isSelect2.current.checked === false) {
        ...
        axios
          .post("http://127.0.0.1:8200/regist", {
            username1,
            password1,
          })
          .then((res) => {
      ...
      <div className="content">
          ...
          <div className="bigbox">
            <div className="selectTop">
              <ul>
                <li
                  ref={loginhead}
                  className="login selectDefault"
                  onClick={() => {
                    setstatus("login");
                  }}
                >
                  密码登录<span ref={loginspan} className="biaoji"></span>
                </li>
                <li
                  ref={registhead}
                  className="regist"
                ...
                >
                  账号注册<span ref={registspan} className="biaoji"></span>
                </li>
              </ul>
            </div>
            {/* 登陆 */}
            <div className="loginbox" ref={login}>
              <div className="loginMiddel">
                ...
                <p className="xieyi" ref={xieyi1}>
                  请先同意美食使用协议
                </p>
                <button onClick={handelLogin}>登陆</button>

                <p>
                  <input type="checkbox" ref={isSelect1} />
                  我已阅读并且同意<a href="#">美食协议</a>
                </p>
              </div>
            ...
            <div className="registbox" ref={regist}>
              <div className="loginMiddel">
                ...
                <p className="xieyi" ref={xieyi2}>
                  请先同意美食使用协议
                </p>
                <button onClick={handelRegister}>注册</button>

                <p>
                  <input type="checkbox" ref={isSelect2} />
                  我已阅读并且同意<a href="#">美食协议</a>
                </p>
              </div>
            </div>
        ...
        <div className="buttomcontent">
          <div>
            ...
            <p>
              ©2009-2015 北京信息技术有限公司 京ICP证111032号
