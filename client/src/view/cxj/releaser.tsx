...
import { Upload } from '_antd@4.16.13@antd';
...
function Releaser() {
        ...
        return num1.map(function (v, i) {
            return (
                <div key={i} className="cinput" >
                    <div className="cinput_l" contentEditable="true">
                    </div>
                    <div className="cinput_r" contentEditable="true">
                    </div>
                    <div className="cbtn">
                        <div className="cxjadd" onClick={add1}>< PlusOutlined /></div>
                        <div className="cxjtop"><ArrowUpOutlined /></div>
                        <div className="cxjbittom"><ArrowDownOutlined /></div>
                        <div className="cxjjian" onClick={deletes1}>< MinusOutlined /></div>
                    </div>
                </div>
        ...
        return num2.map(function (a, i) {
            ...
            return (
                <div className='cstepdes' key={i}>
                    <label htmlFor={"i" + i}>
                        <div className="cstepdes_img" data-url="" style={{ backgroundImage: 'url(https://cp1.douguo.com/static/nweb/images/add.png)', backgroundPosition: 'center center', backgroundRepeat: 'no-repeat', backgroundSize: 'cover' }}>
                            <input type="file" id={"i" + i} hidden className="csubmit2" data-id={i} ref={submitImg2} />
                        </div>
                    </label>
                    <div className="csteptext" contentEditable="true">
                    </div>
                    <div contentEditable="true" style={{ width: '500px', height: '100px' }}  className="cmenudetail"></div>
                    <div className="cstepbtn">
                        <div onClick={add2}>< PlusOutlined /></div>
                        <div><ArrowUpOutlined /></div>
                        <div><ArrowDownOutlined /></div>
                        <div onClick={deletes2}>< MinusOutlined /></div>
                    </div>
    ...
    function scdn() {
        ...
        for (let i = 0; i < allbox.current.children.length; i++) {
            if (allbox.current.children[i].children[0].innerHTML && allbox.current.children[i].children[1].innerHTML) {
                let obj = { name: "", how: "" };
        ...
        axios.post("/uploadCaipu", formData).then((res) => {
            ...
            <div className="creleaser">
                <div className="cmreleaser">
                    <div className="creleaser_img">
                        <input type="file" className="csubmit1" ref={submitImg1} onChange={uploadimg1} />
                        <div className="caddimg">
                            <div className="cadd"><PlusOutlined /></div>
                    ...
                    <div className="cintroduce">
                        ...
                        <input className="cstrtext" ref={recipedes} placeholder="菜品详情" type="text" />
                    </div>
                    ...
                    <div className="caddingredient">
                        ...
                        <div className="caddone caddingone" onClick={add1}>增加一栏</div>
                    </div>
                    <div className="cline"></div>

                    <div className="cddstep">
                        <p >步骤</p>
                        <span className="csurport">（支持上传图片格式有jpg、jpeg、png、gif、webp）</span>
                        <div onChange={uploadimg2} ref={bztp}>
                            {show2()}
                        </div>
                        <div className="caddone caddstepone" onClick={add2}>增加一栏</div>
                    </div>
                </div>
                <div className="cline"></div>
                <button className="cbtnupload" onClick={scdn}>发布</button>
            </div>
