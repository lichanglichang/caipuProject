...
import { idText } from '_typescript@4.4.4@typescript';
...
// 发起请求
    function show() {
        axios.post("http://localhost:8200/showmenu",{
...
// 数组循环遍历
            return list.map(function (showsany:any) {
                return  <div key={showsany.id} className="cshow1small" onClick={repicedes.bind(null,showsany.id)}>
                            <div className="cshows1mall_img">
                                <img src={"http://localhost:8200"+showsany.img} alt="" />
                            </div>
                            <p className="cmuenname">
                            {showsany.menu_name}
                            </p>
                            <div className="cself">
