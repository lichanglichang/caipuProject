            ...
            return god.map((item: any) => {
                return (
                    <div key={item.id} onClick={tzsc}>
                        <div><img className={ma.sptp} src={"http://localhost:8200/public/shopping/" + item.picture} alt={item.id} /></div>
                        <div>
                            <div className={ma.spbt} data-id={item.id}>{item.goodsname}</div>
            ...
            <div className={ma.bx}>
                <div>
                    <div className={ma.mrcp}>
                        <span>每日精选菜谱</span>
                        <span><Link to={{ pathname: '/Menu' }}>更多<RightOutlined /></Link></span>
                    </div>
                ...
                <div>
                    <div className={ma.mrcp}>
                        <span>笔记</span>
                        <span><Link to={{ pathname: '/Notes' }}>更多<RightOutlined /></Link></span>
                    </div>
                ...
                <div style={{display:'flex'}}>
                    <div className={ma.scjx}>
                        <div>
                            <span>商城精选</span>
                            <span className={ma.xxxxx}><Link to={{ pathname: '/shop' }}>更多<RightOutlined /></Link></span>
                        </div>
                        <div className={ma.scbox}>
                            {zcsc()}
                        </div>
                    </div>
                    <div className={ma.syny}>
                        ...
                        <ul>
                            ...
                            <li><Link to={{ pathname: '/Laboratory' }}>智能找菜</Link></li>
                            <li><Link to={{ pathname: '/Laboratory' }}>豆果测试题</Link></li>
                            <li><Link to={{ pathname: '/Laboratory' }}>药品</Link></li>
                        </ul>
                        <div>动漫</div>
                ...
                <div className={ma.djdzs}>
                    ...
                    <div className={ma.sslz} onClick={tzssc}>
                        <div><a href="https://www.360kuai.com/mob/subject/400?sign=ex_28e676e3">新型肺炎实时疫情追踪</a></div>
                        <div>肉食</div>
                        <div>主食</div>
                        <div>烘培</div>
                        <div>素食</div>
