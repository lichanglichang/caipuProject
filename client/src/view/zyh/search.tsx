        ...
        if(yh){
            if(yh.length!==0){
                return yh.map((item:any)=>{
                    return <div key={item.id} style={{width:'200px',margin:'20px 20px'}}>
            ...
            <div className={ms.bx}>
                <Tabs defaultActiveKey="1" onChange={callback} id="qwer">
                    <TabPane tab="菜谱" key="1" >
                        <div style={{ fontSize: '20px', fontWeight: 'bold', margin: '20px 0', textIndent: '2em' }}>{obj.kw}的菜谱</div>
                        <div style={{ display: (sfysj ? 'block' : 'none'), fontSize: '20px', fontWeight: 'bold', margin: '20px 0', textIndent: '2em' }}>
                            没有相关用户的菜谱，请重新查询
                        </div>
                        <div>
                            {szcsp()}
                    ...
                    <TabPane tab="用户" key="3">
                        <div style={{ fontSize: '20px', fontWeight: 'bold', margin: '20px 0', textIndent: '2em' }}>{obj.kw}的相关用户</div>
                        <div style={{ display: (sfyyh ? 'block' : 'none'), fontSize: '20px', fontWeight: 'bold', margin: '20px 0', textIndent: '2em' }}>
                            没有相关用户，请重新查询
                        </div>
